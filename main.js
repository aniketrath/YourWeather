...
function createTodaysForcast(data , day){
...
function createOtherDayForcast(day){
...
function todaysForecast(data) {
    data.daily.forEach((day, idx) => {
        ...
        if (idx == 0) {
            let forecastToday = createTodaysForcast(data, day);
            eachForecast += forecastToday;
        }
        else {
            let forecastOtherDays = createOtherDayForcast(day);
            eachForecast += forecastOtherDays;
